# Generated by Powerlevel10k configuration wizard on 2023-05-31 at 23:28 EDT.
...
() {
  ...
  # Support Emacs vterm directory tracking.
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_END_SEPARATOR=' %{$_vterm_printf%}'
